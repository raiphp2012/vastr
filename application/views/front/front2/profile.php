...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/wp-content/themes/rhapsody/css/product_detail.css">
...
<link href="<?php echo base_url(); ?>assets/wp-content/magiczoomplus.css" rel="stylesheet" type="text/css" media="screen"/>
<script src="<?php echo base_url(); ?>assets/wp-content/magiczoomplus.js" type="text/javascript"></script>
...
<style type="text/css">   
    ...
    .selectors { margin-top: 25px; }
    .selectors .mz-thumb img { max-width: 85px; }
...
<div class="container" style="padding: 25px 0 25px 0;">
	...
	<div class="row">
		<div class="col-lg-6">
				<div class="row">
	<div class="alert-success alert-success col-lg-4" id="msg"> </div>
</div>
			<form action="#">
			  <div class="form-group">
			    <label for="email">User Name:</label>
			    <input type="text" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter email" id="user_name" value="<?php echo  $detaial['user_name']; ?>" name="user_name">			   
			  </div>  <div class="form-group">
			    <label for="email">First Name:</label>
			    <input type="text" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter email" id="first_name" value="<?php echo  $detaial['first_name']; ?>" name="first_name">			   
			  </div>  <div class="form-group">
			    <label for="email">Last Name:</label>
			    <input type="text" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter email" id="last_name" value="<?php echo  $detaial['last_name']; ?>" name="last_name">			   
			  </div>
			  <div class="form-group">
			    <label for="pwd">Phone:</label>
			    <input type="text" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter phone" id="user_phone" value="<?php echo  $detaial['user_phone']; ?>" name="user_phone">
			  </div>
			  <div class="form-group">
			    <label for="pwd">Email:</label>
			    <input type="email" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter email" id="user_email" value="<?php echo  $detaial['user_email']; ?>" name="user_email">
			  </div>
			  <div class="form-group">
			    <label for="pwd">State:</label>
			    <input type="text" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter state" id="state" value="<?php echo  $detaial['state']; ?>" name="state">
			  </div>
			  <div class="form-group">
			    <label for="pwd">City:</label>
		 	    <input type="text" class="form-control" style="background-color:#c0c1c1;" placeholder="Enter city" id="city" value="<?php echo  $detaial['city']; ?>" name="city">
			   </div> 		  
		...
		<div class="col-lg-3">
			<div class="p_border">			
				...
				<div class="fl_price" >					
					<p>User Name:
					<?php echo  $detaial['user_name']; ?>
					</p>
					<p>First Name:
					<?php echo  $detaial['first_name']; ?></p>
					<p>Last Name:
					<?php echo  $detaial['last_name']; ?></p>
					<p>Email:
					<?php echo  $detaial['user_email']; ?></p>
					<p>Phone No.:
					<?php echo  $detaial['user_phone']; ?></p>
...
<div id="text-2" class="widget widget_text"><div class="fancy-title title-border" ><h4>QUICKLINKS</h4></div>		
	...
	<p><a href="t-shirt.html">T-shirt</a><br />
		<a href="shirt.html">Shirt</a><br />
		<a href="footwear.html">Footwear</a><br />
		<a href="winter.html">Winterwear</a><br />
		<a href="bottom.html">Bottomwear</a><br />
		<a href="bags.html">Bags & Backpacks</a><br />
		<a href="account.html">My account</a><br />
		<a href="check.html">Checkout</a><br />
...
<script type="text/javascript">
    $('form').submit(function(e) {
       ...
       var od_address = $("input[name='od_address']").val();
       var state = $("input[name='state']").val();
       var city = $("input[name='city']").val();
            $.ajax({
           url: '<?php echo site_url(); ?>Ajaxcontroller/update_profile',
           type: 'POST',
           data: {first_name:first_name,last_name:last_name,user_email: user_email,user_phone: user_phone ,state: state, city: city},
           error: function() {
              alert('Something is wrong');
           },
           success: function(data) {
               var msg = "Shipping Address Update Succefully";
               $("#msg").html(msg);
           }
        });
