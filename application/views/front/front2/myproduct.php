...
<link rel="stylesheet" href="wp-content/themes/rhapsody/css/product_detail.css">
...
<link href="wp-content/magiczoomplus.css" rel="stylesheet" type="text/css" media="screen"/>
<script src="wp-content/magiczoomplus.js" type="text/javascript"></script>
...
<table class="table table-striped text-center">
 ...
 // print_r($myproduct);die;
  	...
  	$i=0;
  	// print_r($myproduct);
  	if(isset($myproduct) && $myproduct!=''){
  					foreach ($myproduct as $key => $value) {
  						$i++;		
  						$total_price +=$value['price'] * $value['qnty'];
  					  $items++;
  		?>
    <tr>
    	<td style="padding-top: 35px;"><?php echo $i; ?></td>
      <th class="center"><img src="<?php echo base_url(); ?>/assets/images/<?php echo $value['product']['pro_feat_image']; ?> " style="width:100px;"></th>
      <td style="padding-top: 35px;"><?php echo $value['product']['pro_name']; ?></td>
      <td style="padding-top: 35px;"><?php echo $value['qnty']?> </td>
         <td style="padding-top: 35px;"> <?php echo $value['price']; ?> </td>
      <!-- <td style="padding-top: 35px;"> <button class="check"> <a href="#" >Check</a></button> </td> -->
    </tr>
	...
	<div class="row" style="margin: 0 0 15px 0; ">
		...
		<div class="col-lg-6 col-sm-12">
			...
			<div class="p_border">			
				...
				<div class="fl_price" >					
					<p>Order Name:<span><?php echo ucwords($ship_detail['first_name']  .' '.  $ship_detail['last_name']); ?></span></p>
					<p>Email:<span><?php echo $ship_detail['user_email']; ?></p>
					<p>Phone No:<span><?php echo $ship_detail['phone_no']; ?></span></p>
					<p>Address:<span><?php echo $ship_detail['od_address']; ?></span></p>
					<p>Pin Code<span><?php echo $ship_detail['postal_code']; ?></span></p>
				</div>
		...
		<div class="col-lg-6 col-sm-12" >
			...
			<div class="p_border">			
				...
				<div class="fl_price" >
					<p><strong>Total Item: <span><?php echo $items; ?></span></strong></p>
					<p>TOTAL PRICE: <span>र <?php echo $total_price; ?></span></p>
					<p>Discont PRICE:
...
<?php   }else{?>
					 <span>र <?php
					  ...
					  <?php }?></p>	
					<!-- <p>Delivery Charges: <span>र 0</span></p> -->
					<p>Sub Total Price: <span>र <?php echo  $total_price - $dis_amnt; ?></span></p>
				</div>
				<div style="clear:both;"></div>
...
<div class="wpcf7-response-output wpcf7-display-none"></div></form></div></div>
	...
	<div id="copyrights">
		...
		<div class="container clearfix">
			...
			<div class="col_half">
																<a href="http://prathamvision.com/" class="footer-logo standard-logo" ><img src="wp-content/themes/rhapsody/images/logo.png" alt="Logo" ></a>
										
										<a href="" class="footer-logo retina-logo" ><img src="wp-content/themes/rhapsody/images/footer-logo-large.html" alt="Retina Logo" ></a>   
