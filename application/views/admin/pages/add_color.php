...
<h4 class="sub-title">Add color</h4>
<form action="<?php echo base_url(); ?>coloraddaction"method="post" enctype="multipart/form-data">
	<?php
...
<span class="messages text-danger"><?php  echo form_error('c_code')  ?></span>
</div>
</div>
