...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Product Gender</label>
<div class="col-sm-10">
<select name="pro_type" class="form-control fill" id="pro_type">
    <option >Select Gender</option>
    <option value="MALE">MALE</option>
    <option value="FEMALE">FEMALE</option>
</select>
<span class="messages text-danger"><?php   echo form_error('pro_type')    ?></span>
</div>
</div>
<div class="form-group row">
...
<span class="messages text-danger"><?php   echo form_error('sub_child_id')    ?></span>
</div>
</div>
